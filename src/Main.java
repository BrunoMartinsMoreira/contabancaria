    ...
    do {
      ...
      switch (opcao){
        case 1:
          ...
          System.out.printf("Voce depositou R$ %.2f | Saldo atual R$ %.2f", valorTransacao, conta.saldo);
          break;
        case 2:
          System.out.println("Digite o valor do deposito: ");
          valorTransacao = input.nextDouble();
          ...
          if(sucesso) {
            System.out.printf("Voce sacou R$ %.2f | Saldo atual R$ %.2f", valorTransacao, conta.saldo);
          }else{
